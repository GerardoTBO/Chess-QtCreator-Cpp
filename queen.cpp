...
void Queen::wherePiece(Piece* casillas[8][8],bool firstIteracion,bool quede) {
    fs.clear();
...
//    }
    ...
    for(int y=coor.int_y+1; y<8 && direcciones[2]; y++){
        addMovement(direcciones[2],casillas[coor.int_x][y],coor.int_x,y,quede);
    }
...
void Queen::addMovement(bool& d,Piece* p,int x,int y,bool quede){
