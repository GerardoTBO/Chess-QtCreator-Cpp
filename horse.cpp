...
void Horse::wherePiece(Piece* casillas[8][8],bool firstIteracion,bool quede) {
    fs.clear();
    ...
    for (int x = 0; x < 8; x++) {
        for (int y = 0; y < 8; y++) {
            ...
            if(casillas[x][y]->piece_color.compare(piece_color)!=0 && (((x-2 == coor.int_x || x+2 == coor.int_x) && (y-1 == coor.int_y || y+1 == coor.int_y))
